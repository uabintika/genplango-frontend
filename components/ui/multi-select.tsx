...
export function MultiSelectValue({
  ...
  return (
    <div
      ...
      ref={handleResize}
      className={cn(
        "flex w-full max-w-full gap-1.5 overflow-hidden",
